...
/**
 * SOLID-S: только игровой цикл (update + render).
 * SOLID-D: зависит от IInputHandler, не от KeyboardInputHandler.
 */
public class GameScreen implements Screen {
    ...
    // Temp enemy list for removing dead
    ...
    private void update(float dt) {
        ...
        // Hazard tiles (zone 3 void pools)
        if (zone == 3) {
        ...
        // Exit check — all enemies dead (or boss in zone 3)
        ...
        if (cleared && CollisionSystem.dist(player.x,player.y,ex,ey)<16) {
            ...
            // zone 3 handled by boss death above
        }
