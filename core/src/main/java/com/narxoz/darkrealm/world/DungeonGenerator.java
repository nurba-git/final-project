...
/** SOLID-S: только генерация карты. BSP + corridors. */
public class DungeonGenerator {
    ...
    public DungeonData generate(int zone) {
        ...
        // Zone 3 — void hazard pools in corridors
    ...
    // Note: map is stored in DungeonData; this method is unused — kept for API compatibility
}
